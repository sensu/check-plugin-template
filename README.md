...
## Overview
check-plugin-template is a template repository which wraps the [Sensu Plugins Go Library][2].
...
The {{ .Name }} is a [Sensu Check][9] that ...
...
[10]: https://docs.sensu.io/sensu-go/latest/reference/checks/